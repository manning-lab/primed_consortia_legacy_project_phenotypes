...
in.concept <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/CONCEPT.csv", 
                         delim="\t",
                         col_types=cols(
...
in.domain <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/DOMAIN.csv",delim="\t",na="NULL",col_types=cols(
  domain_id = col_character(),
...
```{r  eval=FALSE}
in.concept_class <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/CONCEPT_CLASS.csv",
                               col_types=cols(
                                 concept_class_id = col_character(),
...
```{r  eval=FALSE}
in.relationship <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/RELATIONSHIP.csv", col_types=cols(
...
```{r  eval=FALSE}
in.drug_strength <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/DRUG_STRENGTH.csv", col_types = cols(
...
```{r  eval=FALSE}
in.vocabulary <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/VOCABULARY.csv", col_types = cols(
  vocabulary_id = col_character(),
...
```{r  eval=FALSE}
in.concept_synonym <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/CONCEPT_SYNONYM.csv",col_types=cols(
  concept_id = col_integer(),
...
```{r  eval=FALSE}
in.concept_ancestor <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/CONCEPT_ANCESTOR.csv",col_types=cols(
...
```{r  eval=FALSE}
in.concept_relationship <- read_delim("/Users/amanning/Downloads/vocabulary_download_v5_{38bddeb0-45da-435f-bb8e-6f34aba2ec5a}_1727651640965/CONCEPT_RELATIONSHIP.csv",na="NULL", col_types=cols(
